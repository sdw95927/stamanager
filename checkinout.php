            ...
            <div class="content_item">
                ...
                <div style="background: #FFF;">
                    <div id="col-left">
                        <div id="menu8">
                            <ul>
                                <li><a href="#new">&nbsp;&nbsp;&nbsp;Student Check In / Out</a></li>
                                <li><a href="#new">&nbsp;&nbsp;&nbsp;Teacher Check In / Out</a></li>
                    ...
                    <div id="col-right">
                        ...
                        <div style="margin-left:60px;margin-right:20px;text-align: justify;">
                            ...
                            <div style="padding: 0px 0px 0px 0px;"><h3 id="new"> Student Check In / Out</h3>
                            </div>
                    ...
                    <div id="col-right">
                        ...
                        <div style="margin-left:60px;margin-right:20px;text-align: justify;">
                            ...
                            <div style="padding: 0px 0px 0px 0px;"><h3 id="history"> Teacher Check In / Out</h3>
                            </div>
